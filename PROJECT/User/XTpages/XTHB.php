              ...
              <div class="row 1">
                <div class="col-sm">
                  ...
                  <div class="input-group mb-2">
                    ...
                    <input type="text" name="fullname"  class="form-control" id="inlineFormInputGroup" placeholder="Nhâp tên">
                  </div>
                </div>
                <div class="col-sm">
              ...
              <div class="row 2">
                <div class="col-sm-6">
                  ...
                  <div class="input-group mb-2">
                    ...
                    <input type="date" name="birthday"  class="form-control" id="inlineFormInputGroup" placeholder="Nhập ngày tháng năm sinh">
                  </div>
                </div>
                <div class="col-sm-3">
                  <label class="sr-only" for="inlineFormInputGroup">Nhập tên</label>
